...
/**
 * app\models\EnhancedGiiSearch represents the model behind the search form about `app\models\EnhancedGii`.
 */
 class EnhancedGiiSearch extends EnhancedGii
{
    /**
     * @inheritdoc
     */
