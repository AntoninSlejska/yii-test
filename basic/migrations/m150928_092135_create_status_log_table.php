...
class m150928_092135_create_status_log_table extends Migration
{
    public function up()
    {
      $tableOptions = null;
    ...
    public function down()
    {
        ...
        $this->dropForeignKey('fk_status_log_id', '{{%status_log}}');
        $this->dropForeignKey('fk_status_log_updated_by', '{{%status_log}}');
    }
